...
public class OutboxStateService {
  ...
  /**
   * Atomically performs PENDING/FAILED -> PUBLISHING in an independent transaction. Only the caller
   * whose conditional update affects one row may send the event, preventing concurrent manual and
   * after-commit sends.
   */
