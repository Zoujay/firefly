 ...
 *
 * <p>{@link Propagation#MANDATORY} means this method does not open a new transaction: an existing
 * transaction is required or Spring throws an exception immediately. This is essential here because
 * the business state change and Outbox insert must commit or roll back together. REQUIRES_NEW or no
 * transaction would recreate the exact MySQL/Kafka consistency gap that Outbox is intended to
 * close.
 */
@Service
