...
public class GithubTriggerOriginServiceImpl implements ITriggerOrigin {
    ...
    private static final List<String> DEFAULT_PR_ACTIONS = List.of(
    ...
    public BaseMessage buildMessage(PipelineBuildDto pipelineBuildDto, Long pipelineBuildID) {
        GitHubTriggerConfigEntity config = triggerConfigRepository
        ...
        GitHubRepositorySubscriptionEntity subscription = subscriptionRepository
                ...
                .orElseThrow(() -> new IllegalStateException(
                        "GitHub subscription was not found for trigger config " + config.getId()
                ));
    ...
    public Long saveTriggerOrigin(JsonNode triggerOrigin, Long pipelineID) {
        ...
        List<String> actions = dto.getPullRequestActions() == null
                ? DEFAULT_PR_ACTIONS
                : List.copyOf(new LinkedHashSet<>(dto.getPullRequestActions()));
        LocalDateTime now = LocalDateTime.ofInstant(clock.instant(), ZoneOffset.UTC);
        GitHubTriggerConfigEntity entity = new GitHubTriggerConfigEntity()
