...
class GitHubWebhookIngressServiceTests {
    ...
    void missingHookAndInvalidSignatureUseSameExternalError() {
        ...
        GitHubIntegrationException missing = assertThrows(
        ...
        GitHubIntegrationException invalidSignature = assertThrows(
                GitHubIntegrationException.class,
                () -> ingress().receive(
                        "delivery",
                        "push",
    ...
    void orphanedSubscriptionCannotEnterDeliveryPipeline() {
        ...
        assertThrows(
                GitHubIntegrationException.class,
                () -> ingressWithNoopVerifier().receive(
                        "delivery",
                        "push",
                        99L,
                        "repository",
    ...
    private GitHubWebhookIngressService ingressWithNoopVerifier() {
        GitHubWebhookSignatureVerifier verifier = org.mockito.Mockito.mock(
