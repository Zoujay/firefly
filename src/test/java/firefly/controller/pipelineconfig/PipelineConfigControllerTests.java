...
class PipelineConfigControllerTests {
    ...
    @InjectMocks
    private PipelineConfigController pipelineConfigController;

    @BeforeEach
    void setUp() {
        LocalValidatorFactoryBean validator = new LocalValidatorFactoryBean();
        validator.afterPropertiesSet();
        mockMvc = MockMvcBuilders.standaloneSetup(pipelineConfigController)
    ...
    void createPipelineRejectsShortPipelineUuid() throws Exception {
        mockMvc.perform(post("/create/pipeline")
