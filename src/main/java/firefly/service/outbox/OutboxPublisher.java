...
public class OutboxPublisher {
    ...
    /**
     * Performs exactly one publication attempt; there is deliberately no
     * loop, scheduler, or database poller. Normal writes call this once after
     * commit, while PENDING/FAILED records are retried through the manual
     * administration endpoint.
     *
     * <p>State transitions are PENDING/FAILED -> PUBLISHING -> SENT or FAILED.
